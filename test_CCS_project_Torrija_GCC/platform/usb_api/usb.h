...
extern bIEP0Buffer[];
extern uint8_t abOEP0Buffer[];
extern uint8_t pbXBufferAddressEp1[];
extern uint8_t  pbYBufferAddressEp1[];
extern uint8_t  pbXBufferAddressEp81[];
extern uint8_t  pbYBufferAddressEp81[];
extern uint8_t  pbXBufferAddressEp2[];
extern uint8_t  pbYBufferAddressEp2[];
extern uint8_t  pbXBufferAddressEp82[];
extern uint8_t  pbYBufferAddressEp82[];
