...
tDEVICE_REQUEST __data16 tSetupPacket;

#pragma location = 0x0920
tEDB0 __data16 tEndPoint0DescriptorBlock;

#pragma location = 0x23C8
tEDB __data16 tInputEndPointDescriptorBlock[7];

#pragma location = 0x2388
tEDB __data16 tOutputEndPointDescriptorBlock[7];

#pragma location = 0x2378
uint8_t __data16 abIEP0Buffer[EP0_MAX_PACKET_SIZE];

#pragma location = 0x2370
uint8_t __data16 abOEP0Buffer[EP0_MAX_PACKET_SIZE];

#pragma location = OEP1_X_BUFFER_ADDRESS
 uint8_t __data16 pbXBufferAddressEp1[EP_MAX_PACKET_SIZE];

#pragma location = OEP1_Y_BUFFER_ADDRESS
 uint8_t __data16 pbYBufferAddressEp1[EP_MAX_PACKET_SIZE];

#pragma location = IEP1_X_BUFFER_ADDRESS
 uint8_t __data16 pbXBufferAddressEp81[EP_MAX_PACKET_SIZE];

#pragma location = IEP1_Y_BUFFER_ADDRESS
 uint8_t __data16 pbYBufferAddressEp81[EP_MAX_PACKET_SIZE];

#pragma location = OEP2_X_BUFFER_ADDRESS
 uint8_t __data16 pbXBufferAddressEp2[EP_MAX_PACKET_SIZE];

#pragma location = OEP2_Y_BUFFER_ADDRESS
 uint8_t __data16 pbYBufferAddressEp2[EP_MAX_PACKET_SIZE];

#pragma location = IEP2_X_BUFFER_ADDRESS
 uint8_t __data16 pbXBufferAddressEp82[EP_MAX_PACKET_SIZE];

#pragma location = IEP2_Y_BUFFER_ADDRESS
 uint8_t __data16 pbYBufferAddressEp82[EP_MAX_PACKET_SIZE];

#pragma location = OEP3_X_BUFFER_ADDRESS
uint8_t __data16 pbXBufferAddressEp3[EP_MAX_PACKET_SIZE];
...
extern uint8_t abIEP0Buffer[EP0_MAX_PACKET_SIZE];
extern uint8_t abOEP0Buffer[EP0_MAX_PACKET_SIZE];
extern uint8_t pbXBufferAddressEp1[EP_MAX_PACKET_SIZE];
extern uint8_t pbYBufferAddressEp1[EP_MAX_PACKET_SIZE];
extern uint8_t pbXBufferAddressEp81[EP_MAX_PACKET_SIZE];
extern uint8_t pbYBufferAddressEp81[EP_MAX_PACKET_SIZE];
extern uint8_t pbXBufferAddressEp2[EP_MAX_PACKET_SIZE];
extern uint8_t pbYBufferAddressEp2[EP_MAX_PACKET_SIZE];
extern uint8_t pbXBufferAddressEp82[EP_MAX_PACKET_SIZE];
extern uint8_t pbYBufferAddressEp82[EP_MAX_PACKET_SIZE];
extern uint8_t pbXBufferAddressEp3[EP_MAX_PACKET_SIZE];
//#endif
